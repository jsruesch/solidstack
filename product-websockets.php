...
<?php $current_page = 'product-websockets'; ?>
...
<!-- Hero -->
    <section>
        <div class="full relative product-hero">
            <div class="full grid-vertical-align-content websockets relative">
            <div class="bgs-outline"></div>
                <div class="hero-title-container">
                    <div class="full">
                        <p class="hero-title text-center">
                        SolidStack.<span class="text-reda text-exbold">Websockets</span></p>
                        <p class="text-white text-center mar10-top">
                            Realtime websocket library for multiplayer games. 
                        </p>
                    </div>
                </div>                        
            </div>
